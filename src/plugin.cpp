...
enum Port : uint32_t {
    ...
    P_GRAIN_MS       = 19,   // grain duration     [5 – 200]  ms
    P_XFADE_MS       = 20,   // loop boundary xfade [5 – 100] ms
    P_GRAIN_XFADE_MS = 21,   // grain crossfade    [5 – 100]  ms
...
#ifdef MEGALO_PHASE_VOCODER
        v0 = p->granular.process(ldata, llen, grain_samples, grain_xfade_smp, base_speed);
